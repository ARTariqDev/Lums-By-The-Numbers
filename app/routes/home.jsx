...
export function meta() {
  return [
    ...
    { name: "description", content: "Explore verified LUMS admissions data including SAT scores and grades from accepted and rejected students. Get insights into admission requirements and predict your chances for MGHSS (Economics), MGHSS (Social Sciences), SBASSE, SDSB, and SAHSOL." },
    ...
    { property: "og:description", content: "Explore verified LUMS admissions data including SAT scores and grades from accepted and rejected students across MGHSS (Economics), MGHSS (Social Sciences), SBASSE, SDSB, and SAHSOL." },
    ...
    { name: "twitter:description", content: "Explore verified LUMS admissions data including SAT scores and grades from accepted and rejected students." },
